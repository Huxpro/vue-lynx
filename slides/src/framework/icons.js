...
export const ICONS = {
  ...
  eyeOff: S('<path d="M10.7 5.1A10.8 10.8 0 0 1 12 5c6.5 0 10 7 10 7a18 18 0 0 1-2.2 3.1M6.6 6.6C3.1 8.3 2 12 2 12s3.5 7 10 7a10.3 10.3 0 0 0 5.4-1.6M2 2l20 20M9.9 9.9a2.5 2.5 0 0 0 3.2 3.2"/>'),
  ...
  image: S('<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="10" r="1.5"/><path d="m21 15-4.5-4.5L9 18"/>'),
