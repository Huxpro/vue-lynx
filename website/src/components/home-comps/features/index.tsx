...
const featuresConfig = [
  {
    ...
    desc: {
      en: 'Full support for the Composition API, Single-File Components, and the reactivity system — the same Vue 3 APIs you already know and love.',
      zh: '完整支持组合式 API、单文件组件和响应式系统——你已经熟悉并喜爱的 Vue 3 API。',
    },
    actions: [
  ...
  },
  {
    ...
    desc: {
      en: "Dual-threaded Vue tailor-made for Lynx, carrying over Lynx's native UI responsiveness and main thread scripting.",
      zh: '基于 Lynx 量身定做的双线程 Vue，延续 Lynx 的原生 UI 响应性和主线程脚本能力。',
    },
    illustration: 'item3',
  },
  {
    ...
    title: {
      en: 'Compatible with Vue Ecosystem',
      zh: 'Vue 生态兼容',
    },
    desc: {
      en: 'Bring your favorite Vue libraries and enjoy the rich Vue ecosystem on Lynx.',
      zh: '带上你喜爱的 Vue 库，在 Lynx 上享受丰富的 Vue 生态。',
    },
    actions: [
      ...
      <div className={styles['list-frame']}>
        {featuresConfig.map((item, index) => (
          ...
          >
            ...
            <div className={styles['title']}>{item.title[lang]}</div>
