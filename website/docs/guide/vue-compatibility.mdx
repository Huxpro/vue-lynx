...
:::tip
This page gives a feature-by-feature overview of core Vue features on Lynx. For the mental model behind Vue Lynx's dual-thread architecture, read [Understanding the Dual-Thread Model](/guide/introduction#understanding-the-dual-thread-model).
:::
