...
[Main Thread Script](https://lynxjs.org/next/react/main-thread-script.html) lets us mark functions to run on the main thread, completely eliminating cross-thread round-trip delay.
