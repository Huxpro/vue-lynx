...
[Main Thread Script](https://lynxjs.org/guide/interaction/main-thread-script/quick-start.html) lets us mark functions to run on the main thread, completely eliminating cross-thread round-trip delay.
...
::: info MTS Function Bodies Are Framework-Agnostic
