...
### Run on a native device

To see your app rendered natively, use **Lynx Explorer** — a sandbox app for previewing Lynx bundles on device or simulator. Scan the QR code shown in the terminal, or copy the **Lynx** bundle URL and paste it into "Enter Card URL" in Lynx Explorer.
