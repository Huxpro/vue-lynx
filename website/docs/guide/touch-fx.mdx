...
The hint line under the orb is a button. Press it and the orb stops springing home — it stays wherever you drop it, and the label changes from `TOUCH·DRAG·FLICK` to `TOUCH·DRAG·DROP`. Press it again to put it back.
...
pnpm build
pnpm web:verify   # 9/9 checks: boot, splash, continuity, energy, firework,
                  # settle, stress, and the hidden switch both ways
```
