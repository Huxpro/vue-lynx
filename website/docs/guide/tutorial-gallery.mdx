...
<Go example="gallery" defaultFile="src/GalleryComplete/Gallery.vue" entry="src/GalleryComplete" defaultEntryName="gallery-complete" />
...
<Go example="gallery" defaultFile="src/ImageCard/ImageCard.vue" entry="src/ImageCard" defaultEntryName="gallery-image-card" />
...
<Go example="gallery" defaultFile="src/Components/LikeIcon.vue" entry={["src/Components", "src/LikeCard"]} defaultEntryName="gallery-like-card" />
...
<Go example="gallery" defaultFile="src/GalleryList/Gallery.vue" entry="src/GalleryList" defaultEntryName="gallery-list" />
...
<Go example="gallery" defaultFile="src/GalleryAutoScroll/Gallery.vue" entry="src/GalleryAutoScroll" defaultEntryName="gallery-autoscroll" />
...
<Go example="gallery" defaultFile="src/GalleryScrollbar/NiceScrollbar.vue" entry="src/GalleryScrollbar" defaultEntryName="gallery-scrollbar" />
...
<Go example="gallery" defaultFile="src/GalleryScrollbarCompare/Gallery.vue" entry="src/GalleryScrollbarCompare" defaultEntryName="gallery-scrollbar-compare" />
