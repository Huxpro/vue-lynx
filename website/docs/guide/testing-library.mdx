...
For additional examples, see the test cases in the [vue-lynx testing-library source code](https://github.com/huxpro/vue-lynx/tree/main/testing-library/src/__tests__).
