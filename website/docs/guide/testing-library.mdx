...
:::info
In production, `'main thread'` directive functions are transformed by the build plugin into MTS context objects. In tests, you can pass the MTS context directly as shown above, or use the SWC transform if your Vitest config includes the MTS loader.
:::
