...
需要 **Lynx 引擎 ≥ 3.9.0**，这是首个在标记源码中包含将 CSS 自定义属性从组件根元素传播到其后代的修复（[lynx-family/lynx#5912](https://github.com/lynx-family/lynx/pull/5912)）的版本。在更早的引擎上，变量只会标记在根元素上，无法传递到后代。
