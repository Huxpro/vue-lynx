...
import { catalogManifests } from 'vue-lynx-genui/a2ui/catalog';
...
export const COMPONENT_CATALOG: ComponentDoc[] = [
  ...
  // Upstream lists a `LazyComponent` catalog entry here whose live
  // preview loads a separately-built Lynx lazy bundle
  // (`experimental_isLazyBundle`) — a ReactLynx toolchain feature Vue
  // Lynx does not implement, so the entry is omitted. See PORTING.md.
  {
    name: 'Image',
    category: 'Display',
