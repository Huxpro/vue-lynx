...
| F3.4 | "Thinking…" indicator: 4×4 dot-matrix animation + text shimmer | Port | ☑ | Same pattern sequences; text uses an opacity pulse compatible with both Lynx targets |
