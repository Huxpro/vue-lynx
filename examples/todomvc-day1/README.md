# TodoMVC (Day 1 Tribute)

This is the Day 1 tribute version of [TodoMVC](https://todomvc.com) built with Vue 3 × Lynx using basic CSS Selector styling, before we iteratively improved the CSS to match the pixel-perfect `todomvc-afterall` reference.
