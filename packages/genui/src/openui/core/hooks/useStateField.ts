...
/**
 * Resolve a named OpenUI state field against form state and reactive
 * bindings. Callable during render (functional components) — resolution
 * happens at call time against the live context.
 */
