 ...
 * by `the upstream a2ui-catalog-extractor` from the component's TypeScript
 ...
 */
export type CatalogComponent = GenUIComponent;
 ...
 *
 * @example
 * import { Text, Button } from 'vue-lynx-genui/a2ui';
 * import { defineCatalog, defineFunction } from 'vue-lynx-genui/a2ui';
 * import { required } from 'vue-lynx-genui/a2ui/functions';
 * import textManifest from 'vue-lynx-genui/a2ui/catalog/Text/catalog.json'
 *   with { type: 'json' };
 *
