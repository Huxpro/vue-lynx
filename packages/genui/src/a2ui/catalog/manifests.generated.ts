...
//
// GENERATED — extracted component manifests vendored from the published
// upstream `@lynx-js/genui` package (`a2ui/dist/catalog/<Name>/catalog.json`).
// The upstream extractor parses React TSX and is not ported (see
// PORTING.md); these manifests describe the same protocol surface the Vue
...
} as unknown as Record<string, CatalogManifest>;
