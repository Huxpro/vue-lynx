...
import '../../../../styles/a2ui/catalog/PieChart.css';
 ...
 */
export const PieChart: GenUIComponent = defineComponent({
  name: 'PieChart',
  props: catalogProps(
    'data',
    'variant',
  ...
  setup(rawProps: Record<string, unknown>) {
    const props = rawProps as unknown as PieChartProps;
    ...
    return (): VNodeChild => {
      ...
      return h('view', { class: 'pie-chart' }, [
        h('view', { class: 'pie-chart-header' }, [
          h('view', { class: 'pie-chart-header-copy' }, [
            h('text', { class: 'pie-chart-title' }, title),
            h('text', { class: 'pie-chart-caption' }, subtitle),
          ]),
          h('view', { class: 'pie-chart-kpi' }, [
            h('text', { class: 'pie-chart-kpi-label' }, 'Total'),
            h('text', { class: 'pie-chart-kpi-value' }, formatValue(total)),
          ]),
        ]),
        h('view', { class: 'pie-chart-svg-wrap' }, [
          h('svg', {
            class: 'pie-chart-svg',
            content: svgMarkup,
          ...
          ? h(
            ...
            slices.map((slice, index) => {
              ...
              return h(
                ...
                [
                  h('view', {
                    class: 'pie-chart-legend-swatch',
                    style: { backgroundColor: color },
                  }),
                  h('view', { class: 'pie-chart-legend-copy' }, [
                    h(
                      'text',
                      { class: 'pie-chart-legend-label' },
                      slice.name,
                    ),
                    h(
                      'text',
                      { class: 'pie-chart-legend-value' },
                      showPercentages
