// Plain-DOM Vue 3 (vdom) baseline — same semantics as apps/ui-vdom/src/App.vue
// (shallowRef rows, per-row label refs, keyed v-for), rendered to real DOM.
// Template is runtime-compiled once at mount (vue esm-bundler full build).
...
const App = {
  template: `
  <div class="page">
    <span class="title">Vue vdom (web DOM) UI Benchmark · ready</span>
    <div class="toolbar">
  ...
  setup() {
    ...
    return { rows, selected, creators, update, select, remove, clear, stormUpdate, stormSelect };
  },
};
