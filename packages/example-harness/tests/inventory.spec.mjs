...
describe("example inventory", () => {
  test("accounts for all 26 example directories and 45 configured entries", async () => {
    ...
    expect(inventory.directories).toHaveLength(26);
    expect(inventory.entries).toHaveLength(45);
