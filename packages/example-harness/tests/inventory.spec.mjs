...
describe("example inventory", () => {
  test("accounts for all 28 example directories and 47 configured entries", async () => {
    ...
    expect(inventory.directories).toHaveLength(28);
    expect(inventory.entries).toHaveLength(47);
