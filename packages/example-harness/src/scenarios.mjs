...
export const scenarios = {
  ...
  "scrolling/ListBasic": smoke(),
  "scrolling/ListFilter": smoke(),
  "scrolling/ListInfinite": smoke(),
  "scrolling/ListPrepend": smoke(),
  "scrolling/ListRemove": smoke(),
  "scrolling/ListReorder": smoke(),
  "scrolling/ListWaterfall": smoke(),
  "scrolling/ScrollViewBasic": smoke(),
